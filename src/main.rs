...
unsafe fn vec(chars: &[i64; 8]) -> __m512i {
    _mm512_set_epi64(
        chars[7] * 0x1010101_01010101,
        chars[6] * 0x1010101_01010101,
        chars[5] * 0x1010101_01010101,
        chars[4] * 0x1010101_01010101,
        chars[3] * 0x1010101_01010101,
        chars[2] * 0x1010101_01010101,
        chars[1] * 0x1010101_01010101,
        chars[0] * 0x1010101_01010101,
    )
}
...
unsafe fn b64_decode_impl(mut f: *const i8, l: *const i8, mut dit: *mut i8) {
    while f != l {
        ...
        let sub = _mm512_sub_epi8(
            xs,
            vec(&[
                'A' as i64, 'a' as i64, '0' as i64, '+' as i64, '/' as i64, '-' as i64, '_' as i64,
                '=' as i64,
            ]),
        );
